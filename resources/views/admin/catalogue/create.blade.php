    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select name="user_catalogue_id" class="form-control"
                                                            ...
                                                            @foreach ($userCatalogue as $key => $value)
                                                                <option value="{{ $key }}"
                                                                    {{ old('user_catalogue_id') == $key ? 'selected' : '' }}>
                                                                    {{ $value }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label for="mat-khau">Mật khẩu <span
                                                                class="text-danger">(*)</span></label>
                                                        <input type="password" name="password"
                                                            value="{{ old('password') }}" class="form-control"
                                                            id="mat-khau" required>
                                                        @error('password')
                                                            <div class="text-danger">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label for="nhap-lai-mat-khau">Nhập lại mật khẩu <span
                                                                class="text-danger">(*)</span></label>
                                                        <input type="password" name="re_password"
                                                            value="{{ old('re_password') }}" class="form-control"
                                                            id="nhap-lai-mat-khau" required>
                                                        @error('re_password')
                                                            <div class="text-danger">
                                                                {{ $message }}
                                                            </div>
                ...
                <script>
                    var old_province_id = '{{ old('province_id') }}';
                    var old_district_id = '{{ old('district_id') }}';
                    var old_ward_id = '{{ old('ward_id') }}';
                </script>
            </div>
    </div>
    </section>
