                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="" action="{{ route('role.update', $role) }}" method="POST"
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="display_name"
                                                        ...
                                                        class="form-control" id="display_name" required>
                                                    @error('display_name')
                                                        <div class="text-danger">
                                                            {{ $message }}
                                                        </div>
