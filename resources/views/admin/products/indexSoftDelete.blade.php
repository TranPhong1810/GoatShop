                                            ...
                                            <tbody>
                                                @foreach ($products as $product)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button
                                                                onclick="if(confirm('Bạn chắc chắn muốn khôi phục {{ $product->name }}')) {
                                                                event.preventDefault();
                                                                document.getElementById('restore-form-{{ $product->id }}').submit();
                                                            }"
                                                                class="btn btn-secondary">Restore</button>
                                                            <form id="restore-form-{{ $product->id }}"
                                                                action="{{ route('product.restore', ['id' => $product->id]) }}"
                                                            ...
                                                            <form action="{{ route('product.forceDelete', $product) }}"
